...
function showCategory(category) {
    let productsMarkup = '';
    let productsInCategory = products[`${category}`];
    for (let prod of productsInCategory) {
        let newMarkup = getProductMarkup(prod);
        productsMarkup += newMarkup;
    }
    productsEl.insertAdjacentHTML('afterbegin', productsMarkup);
}
...
function getProductMarkup(product) {
    let resultMarkup = `<div class="product">
